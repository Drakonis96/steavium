...
actor SteamManager {
    ...
    func snapshot() -> SteamEnvironment {
        ...
        return SteamEnvironment(
            ...
            steamExecutablePath: steamExecutable,
    ...
    func installFFmpegDependency() async throws -> String {
        ...
        guard let homebrewPath = detectHomebrewExecutable() else {
            throw SteamManagerError.homebrewNotFound
        }
    ...
    func createDiagnosticsArchive(
        ...
        reportLines.append("Steam installed: \(environment.steamInstalled)")
        reportLines.append("Steam executable: \(environment.steamExecutablePath ?? "-")")
    ...
    func wipeSteamData(clearAccountData: Bool, clearLibraryData: Bool) async throws -> String {
        ...
        guard clearAccountData || clearLibraryData else {
            throw SteamManagerError.dataWipeSelectionRequired
        }
    ...
    private func materializeScript(named: String) throws -> URL {
        ...
        guard fileManager.fileExists(atPath: destinationURL.path) else {
            throw SteamManagerError.missingScript(named)
        }
    ...
    private func deployBundledScripts() throws {
        ...
        for scriptFile in bundledScriptNames {
            ...
            guard let sourceURL = Bundle.module.url(
                ...
                throw SteamManagerError.missingScript(scriptFile)
            }
    ...
    private func synchronizeLaunchOptions(
        ...
        do {
            ...
            throw SteamManagerError.gameProfileLocalConfigWriteFailed(path: localConfigURL.path)
        }
        return true
    }
